...
def count_courses():
    for tutor in Tutor.objects.all():
        count = (
            ...
            .values('session__subtopic__name')
            .annotate(course_count=Count('session__subtopic__name', distinct = True))
            .count()
        )
        ...
        count = (
            Takes.objects.filter(
                tutor_id = tutor.id,
                session__subtopic__topic = 'Communication',
                session__subtopic__level = 1,
            )
            .values('session__subtopic__name')
            .annotate(course_count=Count('session__subtopic__name', distinct = True))
        ...
        count = (
            Takes.objects.filter(
                tutor_id = tutor.id,
                session__subtopic__topic = 'Learning & Study Techniques',
                session__subtopic__level = 1
            )
            .values('session__subtopic__name')
            .annotate(course_count=Count('session__subtopic__name', distinct = True))
        ...
        count = (
            Takes.objects.filter(
                tutor_id = tutor.id,
                session__subtopic__topic = 'Ethics & Equality',
                session__subtopic__level = 1
            )
            .values('session__subtopic__name')
            .annotate(course_count=Count('session__subtopic__name', distinct = True))
        ...
        count = (
            Takes.objects.filter(
                tutor_id = tutor.id,
                session__subtopic__topic = 'Electives',
                session__subtopic__level = 1
            )
            .values('session__subtopic__name')
            .annotate(course_count=Count('session__subtopic__name', distinct = True))
